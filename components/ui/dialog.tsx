...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-xl bg-white/5 p-2 text-zinc-400 opacity-70 transition-opacity hover:bg-white/10 hover:text-white focus:outline-none disabled:pointer-events-none">
        <X className="h-4 w-4" />
